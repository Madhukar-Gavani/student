...
class Adafruit_L3GD20
{
  public:
    ...
    void read(void);
    void calibrateGyro(uint8_t times = 60);
    void setThreshold(uint8_t multiples = 4); 
    void readGyro();     
    
    bool userCalibrate,flag =0;
    uint8_t actualThreshold;
    l3gd20Data data,delta;    // Last read will be available here
    l3gd20Data threshold , threshold_vectors;
    l3gd20Data gyro; //actual gyro output   
